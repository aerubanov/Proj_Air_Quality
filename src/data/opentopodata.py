...
def chunks(lst, n):
    """
    Yield successive n-sized chunks from lst. See details
...
def get_surface_level(
        locations: typing.List[typing.Tuple],
    ...
    for chunk in chunks(locations, 100):
        ...
        resp = requests.get(
                f'https://api.opentopodata.org/v1/srtm30m?locations={payload}'
                )
