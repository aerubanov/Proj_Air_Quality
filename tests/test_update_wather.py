...
def test_check_file(tmpdir):
    ...
    f2 = d.join("data.csv")
    f2.write("# Метеостанция Москва (центр, Балчуг), Россия, WMO_ID=27605, выборка с 01.04.2019 по 08.12.2019,"
             " все дни \n"
             "# Кодировка: UTF-8\n"
             ...
             "# Обозначения метеопараметров см. по адресу http://rp5.ru/archive.php?wmo_id=27605&lang=ru\n"
             "#\n"
             """"Местное время в Москве (центр, Балчуг)";"T";"Po";"P";"Pa";"U";"DD";"Ff";"ff10";"ff3";"N";"WW";"""
